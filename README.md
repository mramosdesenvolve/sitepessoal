...
- **Grafo por cima do retrato, de propósito**: depois do `zoomToFit`, `fitGraph()` desloca a câmera (`centerAt`) mais 130px para a esquerda — sem isso, o layout de força tende a se centralizar todo à direita do contêiner largo (foto+grafo compartilham o mesmo espaço), sem nunca passar sobre a área do retrato.
